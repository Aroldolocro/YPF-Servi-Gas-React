    ...
    <div className="ContactPage-background">
      ...
      <div className="ContactPage-B1">
        ...
        <div className="ContactPage-B1B1">
          <div className="ContactPage-B1B1B1" onClick={() => GoToPhone()}>
            <svg
          ...
          <div className="ContactPage-B1B1B1" onClick={() => GoToWhatsApp()}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
        ...
        <div className="ContactPage-B1B1">
          ...
          <div className="ContactPage-B1B1B1" onClick={() => GoToEmail()}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
            ...
            <p className="ContactPage-txt-4">servigas@uolsinectis.com</p>
          </div>
        </div>
      </div>
