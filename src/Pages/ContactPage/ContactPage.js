...
const ContactPage = () => {
  ...
  const GoToPhone2 = () => (window.location = "tel:+ 54 9 3875 06-5899");

  const GoToEmail = () => (window.location = "mailto:servigas@uolsinectis.com");
  return (
    <div className="ContactPage-background">
      <div className="ContactPage-content">
        ...
        <p className="ContactPage-txt-3">
          Podrás contactarnos y hacer tu pedido cliqueando alguno de los
          siguientes medios:
        </p>
        <div className="ContactPage-B1">
          <div className="ContactPage-B1B1" onClick={() => GoToPhone()}>
            <svg
          ...
          <div className="ContactPage-B1B1" onClick={() => GoToWhatsApp()}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="14"
              height="14"
        ...
        <div className="ContactPage-B1">
          <div className="ContactPage-B1B1" onClick={() => GoToPhone2()}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="14"
              height="14"
            ...
            <p className="ContactPage-txt-4">+ 54 9 3875 06-5899</p>
          </div>
          <div className="ContactPage-B1B1">
            ...
            <p className="ContactPage-txt-4" onClick={() => GoToEmail()}>
              servigas@uolsinectis.com
            </p>
          </div>
